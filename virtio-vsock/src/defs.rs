...
//! Shared definitions for the vsock packet abstractions.
//!
//! This module provides [`PacketHeader`], [`Error`], [`PKT_HEADER_SIZE`],
//! and [`Result`], which are shared between the legacy [`crate::packet`]
//! module and the new [`crate::packet_rw`] module.
